...
/**
 * <bold>253 Students: This is how you should test your program. Generate test cases based on
...
public class LocalTesting {
    ...
    public static void main(String[] args) {
        ...
        //current working directory is "Project2/", so the following path needs to be from
        //  "Project2/" to the test file.  For example, if sample.in is at "Project1/src/Drones/sample.in",
        //  you would put the following: "src/Drones/sample.in"
        String filename = "test/JobSchedulerTest/generator/tests/input02.txt";
        ...
        ArrayList<FinishedJob<?, ?, ?>> finishedJobs = scheduler.getCompletionTimes(filename);
        for (FinishedJob<?, ?, ?> fjob : finishedJobs) {
            System.out.println(fjob.toString());
        }
    }
}
